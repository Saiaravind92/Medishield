...
if __name__ == "__main__":
    ...
    print("Generating 100 US patient clusters (500 document records)...")
    clusters, blurry_doc_idx = generate_patient_clusters(100)
    ...
    amend_with_support_idx = set(rng.sample(range(100), 30))
    amend_handwritten_idx  = set(rng.sample(range(100), 30))
